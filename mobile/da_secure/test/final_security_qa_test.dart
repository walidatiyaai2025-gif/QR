...
void main() {
  test('final QA pins the mobile runtime to the canonical verified HTTPS API', () {
  ...
  test('mobile production sources contain no HTTP fallback or trust-all TLS hook', () {
    ...
    for (final file in sourceFiles) {
      ...
      for (final marker in forbidden) {
        expect(
          ...
          reason: 'Forbidden TLS/HTTP bypass marker "$marker" found in ${file.path}',
        );
      }
    }
  });
