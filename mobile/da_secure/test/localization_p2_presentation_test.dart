...
void main() {
  ...
  testWidgets(
    'Arabic inbox closes P2 labels metadata and target widths',
    (tester) async {
  ...
  testWidgets(
    'English inbox closes P2 labels metadata and target widths',
    (tester) async {
  ...
  testWidgets(
    'secure message bidi isolates attachment technical strings',
    (tester) async {
